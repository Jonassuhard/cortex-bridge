...
// Regression: LIVE-LOGIN-002 — the dedicated ChatGPT profile became unreachable after onboarding.
...
it("keeps the manual ChatGPT connection action visible beside its real status", () => {
  ...
  fireEvent.click(screen.getByRole("button", { name: "Ouvrir le profil ChatGPT" }));
